...
class _AdicionarFinalPaxListaState extends State<AdicionarFinalPaxLista> {
  ...
  Widget build(BuildContext context) {
    final transferDados = Provider.of<Shuttle>(context);
        ...
        children: <Widget>[
                      ...
                      child: RadioListTile(
                        ...
                        onChanged: (index) {
                          setState(() {
                            ...
                            debugPrint(
                                'VAL =${listPaxTransfer[index ?? 0].veiculoNumeracao}');

                            _uidTransfer = listPaxTransfer[index ?? 0].uid;
          ...
          Expanded(
            child: Align(
              ...
              child: _currentTimeValue != null || selectedRadioTile != null
                  ? Padding(
