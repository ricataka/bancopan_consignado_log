...
import 'package:hipax_log/InternoEmbarqueRecepcao/Recepcao/escolher_veiculo_page.dart';
...
class EmbarqueWidget extends StatelessWidget {
  ...
  const EmbarqueWidget({super.key, required this.listaOrigem, this.tipoEmb});
