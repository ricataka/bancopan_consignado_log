...
import 'package:hipax_log/InternoEmbarqueRecepcao/adicionar_pax_widget.dart';
...
class AdicionarPaxPage1 extends StatefulWidget {
  ...
  const AdicionarPaxPage1({super.key, this.transfer, this.identificadorPagina});
...
class _AdicionarPaxPage1State extends State<AdicionarPaxPage1> {
  ...
  Widget build(BuildContext context) {
    ...
    if (transfer.uid == '') {
      ...
      if (transfer.classificacaoVeiculo == 'SHUTTLE') {
      ...
      if (transfer.classificacaoVeiculo == 'INTERNO') {
        List<Participantes> listParticiantes = participantes.toList();
