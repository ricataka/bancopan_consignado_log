...
import 'adicionar_credenciamento_page.dart';
...
class AdicionarCredenciamentoLista extends StatefulWidget {
  final bool? isOPen;
  final String? classificacaoTransfer;
  final Participantes pax;

  const AdicionarCredenciamentoLista(
      {super.key, this.isOPen, required this.pax, this.classificacaoTransfer});

  @override
  State<AdicionarCredenciamentoLista> createState() =>
      _AdicionarCredenciamentoListaState();
}

class _AdicionarCredenciamentoListaState
    extends State<AdicionarCredenciamentoLista> {
  @override
  Widget build(BuildContext context) {
    ...
    if (transfer.isEmpty) {
      ...
      return StreamProvider<Participantes>.value(
        ...
        child: AdicionarCredenciamentoPage(
