...
import 'editar_credenciamento_page.dart';
...
class EditarCredenciamentoLista extends StatefulWidget {
  final bool? isOPen;
  final String? classificacaoTransfer;
  final Participantes pax;

  const EditarCredenciamentoLista(
      {super.key, this.isOPen, required this.pax, this.classificacaoTransfer});

  @override
  State<EditarCredenciamentoLista> createState() =>
      _EditarCredenciamentoListaState();
}

class _EditarCredenciamentoListaState extends State<EditarCredenciamentoLista> {
  @override
  Widget build(BuildContext context) {
    ...
    if (transfer.isEmpty) {
      ...
      return StreamProvider<Participantes>.value(
        ...
        child: EditarCredenciamentoPage(
