...
class ChecarCredencimentoQr extends StatefulWidget {
  const ChecarCredencimentoQr({super.key, this.uidPax, this.reset, required this.pax});
  final String? uidPax;
...
class _ChecarCredencimentoQrState extends State<ChecarCredencimentoQr> {
  ...
  void initState() {
    super.initState();
    isCredenciado = widget.pax.isCredenciamento;
    isEntregaMaterial = widget.pax.isEntregaMaterial;
