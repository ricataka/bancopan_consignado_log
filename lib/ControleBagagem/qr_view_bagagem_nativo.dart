...
class QRViewNativoBagagem extends StatefulWidget {
  const QRViewNativoBagagem({
    Key? key,
  }) : super(key: key);

  @override
  State<StatefulWidget> createState() => _QRViewNativoBagagemState();
}

class _QRViewNativoBagagemState extends State<QRViewNativoBagagem> {
