...
import 'package:hipax_log/Recepcao/escolher_veiculo_widget.dart';
  ...
  Widget build(BuildContext context) {
    ...
    if (listpax.isEmpty) {
      ...
      List<TransferIn> listtransfer = transfer
          .where((o) =>
              o.classificacaoVeiculo == 'IN' || o.classificacaoVeiculo == "OUT")
          .toList();
      ...
      if (widget.modalidadeEmbarque == 'Embarque') {
        ...
        int getTotalParticipantes(String uid) {
          List<Participantes> listParticipantesTotalIn =
              listpax.where((o) => o.uidTransferIn == uid).toList();
