...
class QrTriagem extends StatefulWidget {
  const QrTriagem({
    Key? key,
  }) : super(key: key);

  @override
  State<StatefulWidget> createState() => _QrTriagemState();
}

class _QrTriagemState extends State<QrTriagem> {
                    ...
                    for (var element in participantes) {
                      ...
                      if (element.uid == code) {
                        ...
                        Navigator.of(context, rootNavigator: true)
                          ...
                          page: TriagemWidget(pax: element),
                        ));
                      }
                    }
                  }
