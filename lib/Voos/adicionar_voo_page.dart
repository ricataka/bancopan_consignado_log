...
class AdicionarVooPage extends StatefulWidget {
  ...
  @override
  State<AdicionarVooPage> createState() => _AdicionarVooPageState();
}

class _AdicionarVooPageState extends State<AdicionarVooPage> {
  ...
  var selectedAeroportoOrigem1 = Aeroporto();
  var selectedAeroportoDestino1 = Aeroporto();
  ...
  void initState() {
    ...
    if (widget.tipoTrecho == 'IDA') {
      ...
      _cia1 = '';
      _origem1 = '';
      _previsaoSaida1 = Timestamp.now();
      _previsaoChegada1 = Timestamp.now();
      _destino1 = '';
      _loc1 = '';
      _eticket1 = '';
      ...
      _cia2 = '';
      _origem2 = '';
      _previsaoSaida2 = Timestamp.now();
      _previsaoChegada2 = Timestamp.now();
      _destino2 = '';
      _loc2 = '';
      _eticket2 = '';
      ...
      _cia21 = '';
      _origem21 = '';
      _previsaoSaida21 = Timestamp.now();
      _previsaoChegada21 = Timestamp.now();
      _destino21 = '';
      _loc21 = '';
      _eticket21 = '';
      listaAeroportos
      ...
      for (var aeroporto in listaAeroportos) {
        if (aeroporto.nomeAeroporto == _origem1) {
          aeroportoOrigem1 = aeroporto;
        }
        if (aeroporto.nomeAeroporto == _destino1) {
          aeroportoDestino1 = aeroporto;
        }
        if (aeroporto.nomeAeroporto == _origem2) {
          aeroportoOrigem2 = aeroporto;
        }
        if (aeroporto.nomeAeroporto == _destino2) {
          aeroportoDestino2 = aeroporto;
        }
        if (aeroporto.nomeAeroporto == _origem21) {
          aeroportoOrigem21 = aeroporto;
        }
        if (aeroporto.nomeAeroporto == _destino21) {
    ...
    if (widget.tipoTrecho == 'VOLTA') {
      ...
      _cia3 = '';
      _origem3 = '';
      _previsaoSaida3 = Timestamp.now();
      _previsaoChegada3 = Timestamp.now();
      _destino3 = '';
      _loc3 = '';
      _eticket3 = '';
      ...
      _cia4 = '';
      _origem4 = '';
      _previsaoSaida4 = Timestamp.now();
      _previsaoChegada4 = Timestamp.now();
      _destino4 = '';
      _loc4 = '';
      _eticket4 = '';
      listaAeroportos
      ...
      _cia41 = '';
      _origem41 = '';
      _previsaoSaida41 = Timestamp.now();
      _previsaoChegada41 = Timestamp.now();
      _destino41 = '';
      _loc41 = '';
      _eticket41 = '';
      listaAeroportos
      ...
      for (var aeroporto in listaAeroportos) {
        if (aeroporto.nomeAeroporto == _origem3) {
          aeroportoOrigem3 = aeroporto;
        }
        if (aeroporto.nomeAeroporto == _destino3) {
          aeroportoDestino3 = aeroporto;
        }
        if (aeroporto.nomeAeroporto == _origem4) {
          aeroportoOrigem4 = aeroporto;
        }
        if (aeroporto.nomeAeroporto == _destino4) {
          aeroportoDestino4 = aeroporto;
        }
        if (aeroporto.nomeAeroporto == _origem41) {
          aeroportoOrigem41 = aeroporto;
        }
        if (aeroporto.nomeAeroporto == _destino41) {
                            ...
                            children: [
                              Container(
                                ...
                                child: DropdownButtonFormField<String>(
                                  ...
                                  items: listaCompanhia.map((values) {
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    DateTimeField(
                                      ...
                                      selectedDate: _previsaoSaida21.toDate(),
                                    ),
                                  ],
                                ),
                              ),
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    DateTimeField(
                                      ...
                                      dateFormat: format,
                                      initialDate: DateTime.now(),
                                      selectedDate: _previsaoChegada21.toDate(),
                                    ),
                                  ],
                                ),
                              ),
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    DateTimeField(
                                      ...
                                      dateFormat: format,
                                      initialDate: DateTime.now(),
                                      selectedDate: _previsaoSaida2.toDate(),
                                    ),
                                  ],
                                ),
                              ),
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    DateTimeField(
                                      ...
                                      dateFormat: format,
                                      initialDate: DateTime.now(),
                                      selectedDate: _previsaoSaida1.toDate(),
                                    ),
                                  ],
                                ),
                              ),
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    DateTimeField(
                                      ...
                                      dateFormat: format,
                                      initialDate: DateTime.now(),
                                      selectedDate: _previsaoChegada1.toDate(),
                                    ),
                                  ],
                                ),
                              ),
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    DateTimeField(
                                      ...
                                      dateFormat: format,
                                      initialDate: DateTime.now(),
                                      selectedDate: _previsaoChegada2.toDate(),
                                    ),
                                  ],
                                ),
                              ),
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    DateTimeField(
                                      ...
                                      dateFormat: format,
                                      initialDate: DateTime.now(),
                                      selectedDate: _previsaoSaida3.toDate(),
                                    ),
                                  ],
                                ),
                              ),
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    DateTimeField(
                                      ...
                                      dateFormat: format,
                                      initialDate: DateTime.now(),
                                      selectedDate: _previsaoChegada3.toDate(),
                                    ),
                                  ],
                                ),
                              ),
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    DateTimeField(
                                      ...
                                      dateFormat: format,
                                      initialDate: DateTime.now(),
                                      selectedDate: _previsaoSaida4.toDate(),
                                    ),
                                  ],
                                ),
                              ),
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    DateTimeField(
                                      ...
                                      dateFormat: format,
                                      initialDate: DateTime.now(),
                                      selectedDate: _previsaoChegada4.toDate(),
                                    ),
                                  ],
                                ),
                              ),
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    DateTimeField(
                                      ...
                                      dateFormat: format,
                                      initialDate: DateTime.now(),
                                      selectedDate: _previsaoSaida41.toDate(),
                                    ),
                                  ],
                                ),
                              ),
  ...
  Widget nextButtonEscalaIda(String uid) {
    return TextButton(
      onPressed: () {
        if (activeStep == 0) {
          final validate1 = _formKey1.currentState?.validate() ?? false;
          if (validate1) {
            setState(() {
              activeStep++;
            });
        ...
        final validate2 = _formKey2.currentState?.validate() ?? false;
        if (activeStep == 1) {
          if (validate2) {
            setState(() {
  ...
  Widget nextButtonEscalaIda2(String uid) {
    return TextButton(
      onPressed: () {
        ...
        if (activeStep == 2) {
          final validate3 = _formKey3.currentState?.validate() ?? false;
          if (validate3) {
            setState(() {
