...
class ListaSelecionadoWidget1 extends StatefulWidget {
  final Participantes participante;
  final ValueChanged<bool> isSelected;

  const ListaSelecionadoWidget1({super.key, 
    required this.isSelected,
    required this.participante,
  });
  @override
  State<ListaSelecionadoWidget1> createState() =>
      _ListaSelecionadoWidget1State();
}

class _ListaSelecionadoWidget1State extends State<ListaSelecionadoWidget1> {
  @override
