...
class EditarVeiculoForm2 extends StatefulWidget {
  final List<String> listLocais;
  final List<TransferIn> listTransfer;
  const EditarVeiculoForm2(
      {super.key, required this.listLocais, required this.listTransfer});

  @override
  State<EditarVeiculoForm2> createState() => _EditarVeiculoForm2State();
}

class _EditarVeiculoForm2State extends State<EditarVeiculoForm2> {
