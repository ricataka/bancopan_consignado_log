  ...
  Widget build(BuildContext context) {
    ...
    if (transfer.uid == '') {
      ...
      List<Participantes> listPaxTransfer2In = participantes
          .where((o) => o.uidTransferIn2 == widget.transfer.uid)
          .toList();
      ...
      List<Participantes> listOutOtal = participantes
          .where((o) => o.uidTransferOuT2 == widget.transfer.uid)
          .toList();
                    ...
                    for (var element in participantes) {
                      if (element.uid == code) {
                        ...
                        if (widget.transfer.classificacaoVeiculo ==
                            'INTERNO IDA') {
                          DatabaseServiceParticipante().updateEmbarcarPax2(
                        ...
                        if (widget.transfer.classificacaoVeiculo ==
                            'INTERNO VOLTA') {
                          DatabaseService()
                              .updateParticipantesTransferenciaOut2(
                                  element.uid, widget.transfer.uid ?? '');
