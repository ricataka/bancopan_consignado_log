      ...
      Widget alertaRemoverPaxTransfer = AlertDialog(
        ...
        actions: <Widget>[
          ...
          TextButton(
            onPressed: () {
              DatabaseService()
                  .updateParticipantesuidOut2(widget.participante.uid, '');
      ...
      return AbsorbPointer(
        ...
        child: Dismissible(
          ...
          confirmDismiss: (direction) async {
            if (widget.participante.isEmbarqueOut2 == false &&
                direction == DismissDirection.startToEnd) {
              DatabaseServiceParticipante()
                  .updateParticipantesEmbarcarOUTOk2(widget.participante.uid);
            }
            ...
            if (widget.participante.isEmbarqueOut2 == true &&
                direction == DismissDirection.startToEnd) {
              return;
            }
            ...
            if (widget.participante.isEmbarqueOut2 == true &&
                direction == DismissDirection.endToStart) {
              DatabaseServiceParticipante()
                  .updateParticipantesCancelarOUTEmbarque2(
                        ...
                        children: <Widget>[
                          ...
                          Row(
                            children: [
                              ...
                              Container(
                                child:
                                    widget.participante.isEmbarqueOut2 == true
                                        ? const Icon(
