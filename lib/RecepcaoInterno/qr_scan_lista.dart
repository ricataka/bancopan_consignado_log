  ...
  Widget build(BuildContext context) {
    ...
    if (transfer.uid == '') {
      ...
      List<Participantes> listEmbarqueIn = participanteTransfer
          .where((o) =>
              o.isEmbarque2 == true && o.uidTransferIn2 == widget.transfer.uid)
          .toList();
        ...
        controller.scannedDataStream.listen((scanData) {
          for (var element in participantes) {
            ...
            if (element.uid == qrText) {
              ...
              if (widget.transfer.classificacaoVeiculo == 'INTERNO IDA') {
                DatabaseServiceParticipante()
                    .updateEmbarcarPax2(element.uid, widget.transfer.uid ?? '');

                Navigator.of(context).pop();
              }

              if (widget.transfer.classificacaoVeiculo == 'INTERNO VOLTA') {
                DatabaseService().updateParticipantesTransferenciaOut2(
      ...
      return Scaffold(
        ...
        body: Column(
          children: <Widget>[
            ...
            widget.transfer.classificacaoVeiculo == 'INTERNO IDA'
                ? Center(
                    child: Material(
