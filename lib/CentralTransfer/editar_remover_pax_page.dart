...
class EditarRemoverPaxPage extends StatefulWidget {
  final TransferIn transfer;

  const EditarRemoverPaxPage({super.key, required this.transfer});

  @override
  State<EditarRemoverPaxPage> createState() => _EditarRemoverPaxPageState();
}

class _EditarRemoverPaxPageState extends State<EditarRemoverPaxPage> {
  ...
  Widget build(BuildContext context) {
    ...
    if (transfer.uid == '') {
      ...
      DateTime horaSaida = transfer.previsaoSaida?.toDate() ??
