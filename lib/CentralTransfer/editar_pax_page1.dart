...
import 'package:hipax_log/CentralTransfer/editar_pax_widget2.dart';
...
class _EditarPaxPage1State extends State<EditarPaxPage1>
  ...
  Widget build(BuildContext context) {
    ...
    // if (transfer.totalParticipantes) {
    //   return const Loader();
    // } else {
      if (transfer.classificacaoVeiculo == 'IN') {
        ...
        List<Participantes> listEmbarque = participantesTransfer
            .where(
                (o) => o.isEmbarque == true && o.uidTransferIn == transfer.uid)
            .toList();
        ...
        List<Participantes> listParticipantesTotalInEmbarcados =
            participantesTransfer
                .where((o) =>
                    o.uidTransferIn == transfer.uid && o.isEmbarque == true)
                .toList();
      ...
      if (transfer.classificacaoVeiculo == 'OUT') {
        List<TransferIn> listtransferin = listtransfer
            .where((o) =>
        ...
        List<Participantes> listParticiantes = participantesTransfer
            .where((o) => o.uidTransferOuT == transfer.uid)
            .toList();
        List<Participantes> listAusente = participantesTransfer
            .where((o) =>
                o.isEmbarqueOut == false && o.uidTransferOuT == transfer.uid)
            .toList();
        List<Participantes> listEmbarque = participantesTransfer
            .where((o) =>
        ...
        DateTime horaInicioViagem =
            transfer.horaInicioViagem?.toDate().toUtc() ??
                DateTime.fromMillisecondsSinceEpoch(0);
        DateTime horaFimViagem = transfer.horaFimViagem?.toDate().toUtc() ??
            DateTime.fromMillisecondsSinceEpoch(0);
