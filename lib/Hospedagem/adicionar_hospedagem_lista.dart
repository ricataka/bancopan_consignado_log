...
import 'adicionar_hospedagem_page.dart';
...
class AdicionarHospedagemLista extends StatefulWidget {
  final bool? isOPen;
  final String? classificacaoTransfer;
  final Participantes pax;

  const AdicionarHospedagemLista(
      {super.key, this.isOPen, required this.pax, this.classificacaoTransfer});

  @override
  State<AdicionarHospedagemLista> createState() =>
      _AdicionarHospedagemListaState();
}

class _AdicionarHospedagemListaState extends State<AdicionarHospedagemLista> {
  @override
