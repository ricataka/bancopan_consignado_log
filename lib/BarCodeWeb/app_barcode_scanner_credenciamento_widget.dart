...
///
/// AppBarcodeScannerCredenciamentoWidget
class AppBarcodeScannerCredenciamentoWidget extends StatefulWidget {
  ///
  ///
  AppBarcodeScannerCredenciamentoWidget.defaultStyle({super.key, 
  ...
  @override
  State<AppBarcodeScannerCredenciamentoWidget> createState() => _AppBarcodeState();
}

class _AppBarcodeState extends State<AppBarcodeScannerCredenciamentoWidget> {
  @override
...
class _BarcodeScannerWidget extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _AppBarcodeScannerCredenciamentoWidgetState();
  }
}

class _AppBarcodeScannerCredenciamentoWidgetState
