...
class BarraNavegacaoCredenciamentoPainel extends StatefulWidget {
  const BarraNavegacaoCredenciamentoPainel({super.key});

  @override
  State<BarraNavegacaoCredenciamentoPainel> createState() =>
      _BarraNavegacaoCredenciamentoPainelState();
}

class _BarraNavegacaoCredenciamentoPainelState
    extends State<BarraNavegacaoCredenciamentoPainel> {
  ...
  Widget build(BuildContext context) {
    ...
    if (pax.isEmpty) {
      ...
      List<Participantes> lisPaxTotal = pax
          .where((o) =>
      ...
      List<Participantes> listPaxCredenciado = pax
          .where(
              (o) => o.isCredenciamento == true && o.hasCredenciamento == true)
          .toList();
      listPaxCredenciado.sort((a, b) => a.nome.compareTo(b.nome));
                ...
                children: [
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                          'Lista Credenciados'.toUpperCase(),
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Nenhum participante credenciado',
                            style: GoogleFonts.lato(
                              fontSize: 16,
                              color: Colors.black87,
