...
class BarraNavegacaoVeiculosIN extends StatelessWidget {
  const BarraNavegacaoVeiculosIN({super.key});
    ...
    if (listpax.isEmpty) {
      ...
      int getTotalParticipantes(String uid) {
        ...
        List<Participantes> listParticipantesTotalOut =
            listpax.where((o) => o.uidTransferOuT == uid).toList();
      ...
      for (var element in listTotal) {
        ...
        // print('contador programado$contadorPaxProgramado');
      }
      ...
      for (var element in listFinalizado) {
        ...
        // print('contador programado$contadorPaxFinalizado');
      }
