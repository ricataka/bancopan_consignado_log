              ...
              for (int i = 0; i < widget.transfer.participante.length; i++) {
                if (widget.transfer.participante[i] ==
                  ...
                  DatabaseServiceShuttle().removerPaxShuttle(
                      widget.transfer.uid, widget.transfer.participante[i]);
                  DatabaseServiceShuttle()
                      .updateDetrimentoEmbarcadoCarro(widget.transferUid);
                  DatabaseService()
                      .updateEMbarcadoShuttleCancelar(widget.participante.uid);
        ...
        child: Dismissible(
          ...
          confirmDismiss: (direction) async {
            ...
            if (widget.participante.isVar2 == false &&
              ...
              DatabaseService()
                  .updateEMbarcadoShuttleOK(widget.participante.uid);
            }

            if (widget.participante.isVar2 == true &&
                direction == DismissDirection.endToStart) {
              DatabaseServiceShuttle()
                  .updateDetrimentoEmbarcadoCarro(widget.transferUid);
              DatabaseService()
                              ...
                              pax.cancelado == true || pax.noShow == true
                                  ...
                                  : Row(
                                      ...
                                      children: [
                                        ...
                                        widget.participante.isVar2 == true
                                            ? const Icon(
