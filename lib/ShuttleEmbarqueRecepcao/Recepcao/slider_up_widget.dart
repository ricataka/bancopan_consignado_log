...
import 'package:hipax_log/ShuttleEmbarqueRecepcao/Recepcao/qr_scan_page.dart';
import 'package:hipax_log/ShuttleEmbarqueRecepcao/sheet_embarque_pax.dart';
        ...
        TextButton(
          onPressed: () {
            ...
            DatabaseServiceNotificacoes().setNotificacoes(
                ...
                false);
            DatabaseServiceShuttle()
                .updateStatuCarroEmTransito(transferpainel.uid, user.email);
      ...
      actions: <Widget>[
        ...
        TextButton(
          onPressed: () {
            ...
            Navigator.pop(context);
            DatabaseServiceShuttle()
                .updateStatuCarroEmFinalizado(transferpainel.uid, user.email);
            Navigator.pop(context);
